...
def run_memory_leak_checker(directory, is_good):
    ...
    for file in sorted(os.listdir(directory)):
        if file.endswith('.java'):
            ...
            return_code = subprocess.call('{} ./{} {}'.format(valgrind, compiler, test), shell=True)
...
false_negatives_count, total_good_tests_count = run_memory_leak_checker('testlib/good-samples/', True)
false_positives_count, total_bad_tests_count = run_memory_leak_checker('testlib/bad-samples/', False)
